...
class ReplyTopicTests(ReplyTopicTestCase):
    ...
    def test_form_inputs(self):
        ...
        '''
        self.assertContains(self.response, '<input', 2) # CHANGED from 1 to 2. May be related to Log out link implemented as a form because GET is forbidden for logouts.
